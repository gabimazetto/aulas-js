...
//Operador AND(&&) = Todas as expressões têm que ser "true"
...
let idade = 30;
let podeBeber = idade >= 18 && idade <= 59; //De 18 até 59 anos pode beber
let podeDirigir = idade <= 18 || idade <= 59;
// Basta idade <= 18 ser verdadeira para podeDirigir ser true.

let media = 8.5;
let sabeIngles = true;
let aprovado = media >= 7;

//O candidato será contratado caso seja aprovado e saiba inglês.
